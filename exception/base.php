...
namespace marttiphpbb\calendarmonthview\exception;
...
class base extends \Exception
{
	...
	* @return \marttiphpbb\calendarmonthview\exception\base
	* @access public
	*/
	...
	*/
	public function add_lang(\phpbb\user $user)
	{
		...
		// Add our language file
		$user->add_lang_ext('marttiphpbb/calendarmonthview', 'exceptions');
